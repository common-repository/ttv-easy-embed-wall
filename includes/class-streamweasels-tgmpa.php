...
class TGM_Plugin_Activation_SwtiWall {
	function swti_register_required_plugins() {
		/*
		...
		*/
		$plugins = array(
			...
			array(
				...
				'required'  => false,
				'is_callable' => 'run_streamweasels'
			),array(
				'name'      => 'StreamWeasels Twitch Integration Pro',
				'slug'      => 'streamweasels-twitch-integration-pro',
				'external_url' => 'https://checkout.freemius.com/mode/dialog/plugin/9086/plan/15236/?trial=paid',
				'required'  => false,
				'is_callable' => 'run_streamweasels',
			)    
		);
		...
		*/
		$config = array(
			...
			'has_notices'  => true,
			'dismissable'  => false,
			'dismiss_msg'  => 'Twitch Wall has a new home! Please install <strong>StreamWeasels Twitch Integration</strong> instead.',
			'is_automatic' => true,
			'message'      => '<br><p>You can use our free plugin - <strong>StreamWeasels Twitch Integration</strong> or upgrade to <a href="https://checkout.freemius.com/mode/dialog/plugin/9086/plan/15236/" target="_blank">StreamWeasels Twitch Integration PRO</a> for more features.</p>',                      // Message to output right before the plugins table.
		);
